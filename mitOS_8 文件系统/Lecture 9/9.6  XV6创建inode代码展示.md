...
[![](https://github.com/huihongxiao/MIT6.S081/raw/master/.gitbook/assets/image%20(494).png)](https://github.com/huihongxiao/MIT6.S081/blob/master/.gitbook/assets/image%20\(494\).png)

在sys_open函数中，会调用create函数。

[![](https://github.com/huihongxiao/MIT6.S081/raw/master/.gitbook/assets/image%20(565).png)](https://github.com/huihongxiao/MIT6.S081/blob/master/.gitbook/assets/image%20\(565\).png)

create函数中首先会解析路径名并找到最后一个目录，之后会查看文件是否存在，如果存在的话会返回错误。之后就会调用ialloc（inode allocate），这个函数会为文件x分配inode。ialloc函数位于fs.c文件中。

[![](https://github.com/huihongxiao/MIT6.S081/raw/master/.gitbook/assets/image%20(553).png)](https://github.com/huihongxiao/MIT6.S081/blob/master/.gitbook/assets/image%20\(553\).png)
...
[![](https://github.com/huihongxiao/MIT6.S081/raw/master/.gitbook/assets/image%20(433).png)](https://github.com/huihongxiao/MIT6.S081/blob/master/.gitbook/assets/image%20\(433\).png)

bread函数首先会调用bget函数，bget会为我们从buffer cache中找到block的缓存。让我们看一下bget函数

[![](https://github.com/huihongxiao/MIT6.S081/raw/master/.gitbook/assets/image%20(592).png)](https://github.com/huihongxiao/MIT6.S081/blob/master/.gitbook/assets/image%20\(592\).png)
...
[![](https://github.com/huihongxiao/MIT6.S081/raw/master/.gitbook/assets/image%20(607).png)](https://github.com/huihongxiao/MIT6.S081/blob/master/.gitbook/assets/image%20\(607\).png)
