...
[![](https://github.com/huihongxiao/MIT6.S081/raw/master/.gitbook/assets/image%20(410).png)](https://github.com/huihongxiao/MIT6.S081/blob/master/.gitbook/assets/image%20\(410\).png)

之后系统调用需要读写block，它可以通过get获取block在buffer中的缓存，同时告诉handle这个block需要被读或者被写。如果你需要更改多个block，类似的操作可能会执行多次。之后是修改位于缓存中的block。

[![](https://github.com/huihongxiao/MIT6.S081/raw/master/.gitbook/assets/image%20(428).png)](https://github.com/huihongxiao/MIT6.S081/blob/master/.gitbook/assets/image%20\(428\).png)

当这个系统调用结束时，它会调用stop函数，并将handle作为参数传入。

[![](https://github.com/huihongxiao/MIT6.S081/raw/master/.gitbook/assets/image%20(518).png)](https://github.com/huihongxiao/MIT6.S081/blob/master/.gitbook/assets/image%20\(518\).png)
