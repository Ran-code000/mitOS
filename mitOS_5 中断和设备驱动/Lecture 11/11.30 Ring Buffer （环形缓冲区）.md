...
[![](https://github.com/huihongxiao/MIT6.S081/raw/master/.gitbook/assets/image%20(864).png)](https://github.com/huihongxiao/MIT6.S081/blob/master/.gitbook/assets/image%20\(864\).png)
...
[![](https://github.com/huihongxiao/MIT6.S081/raw/master/.gitbook/assets/image%20(403)%20(1)%20(1)%20(1).png)](https://github.com/huihongxiao/MIT6.S081/blob/master/.gitbook/assets/image%20\(403\)%20\(1\)%20\(1\)%20\(1\).png)
...
[![](https://github.com/huihongxiao/MIT6.S081/raw/master/.gitbook/assets/image%20(386)%20(1)%20(1)%20(1)%20(1).png)](https://github.com/huihongxiao/MIT6.S081/blob/master/.gitbook/assets/image%20\(386\)%20\(1\)%20\(1\)%20\(1\)%20\(1\).png)
...
[![](https://github.com/huihongxiao/MIT6.S081/raw/master/.gitbook/assets/image%20(722).png)](https://github.com/huihongxiao/MIT6.S081/blob/master/.gitbook/assets/image%20\(722\).png)
...
[![](https://github.com/huihongxiao/MIT6.S081/raw/master/.gitbook/assets/image%20(794).png)](https://github.com/huihongxiao/MIT6.S081/blob/master/.gitbook/assets/image%20\(794\).png)

当网卡收到packet时，网卡还会记住当前应该在DMA ring的哪个位置并通过DMA将packet传输过去。

[![](https://github.com/huihongxiao/MIT6.S081/raw/master/.gitbook/assets/image%20(817).png)](https://github.com/huihongxiao/MIT6.S081/blob/master/.gitbook/assets/image%20\(817\).png)

传输完成之后，网卡会将内部的记录的指针指向DMA ring的下一个位置，这样就可以拷贝下一个packet。

[![](https://github.com/huihongxiao/MIT6.S081/raw/master/.gitbook/assets/image%20(641).png)](https://github.com/huihongxiao/MIT6.S081/blob/master/.gitbook/assets/image%20\(641\).png)

刚才说的都是接收packet，对应的是RX ring。类似的，驱动还会设置好发送buffer，也就是TX ring。驱动会将需要网卡传输的packet存储在 TX ring中，网卡也需要知道TX ring的地址。

[![](https://github.com/huihongxiao/MIT6.S081/raw/master/.gitbook/assets/image%20(804).png)](https://github.com/huihongxiao/MIT6.S081/blob/master/.gitbook/assets/image%20\(804\).png)
